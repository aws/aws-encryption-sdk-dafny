...
namespace AWSEncryptionSDK
{
    ...
    public class AWSKMSClientSuppliers {
        ...
        // enumerable of region strings. The LimitRegionsClientSupplier will only return an AWS KMS service client from
        // the given AWSKMSClientSupplier if the region provided to GetClient(region) is in the list of regions
        // associated with the LimitRegionsClientSupplier.
        ...
        // An implementation of an AWSKMSClientSupplier that takes in an existing AWSKMSClientSupplier as well as an
        // enumerable of region strings. The ExcludeRegionsClientSupplier will only return an AWS KMS service client from
        // the given AWSKMSClientSupplier if the region provided to GetClient(region) is not in the list of regions
        // associated with the ExcludeRegionsClientSupplier.
