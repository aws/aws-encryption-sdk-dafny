  ...
  MaterialProviders.Client
{
  ...
  export
    ...
    provides
      ...
      AwsCryptographicMaterialProvidersClient.config
  ...
  {
    const config: Crypto.AwsCryptographicMaterialProvidersClientConfig;

    constructor (config: Crypto.AwsCryptographicMaterialProvidersClientConfig)
