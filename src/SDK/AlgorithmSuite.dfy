...
module AlgorithmSuite {
  ...
  const Suite := map [
    AES_256_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 := AlgSuite(CipherParams(AES256, 16, 12), Digests.HmacSHA384, Some(S.ECDSA_P384)),
    AES_192_GCM_IV12_TAG16_HKDF_SHA384_ECDSA_P384 := AlgSuite(CipherParams(AES192, 16, 12), Digests.HmacSHA384, Some(S.ECDSA_P384)),
    AES_128_GCM_IV12_TAG16_HKDF_SHA256_ECDSA_P256 := AlgSuite(CipherParams(AES128, 16, 12), Digests.HmacSHA256, Some(S.ECDSA_P256)),
    AES_256_GCM_IV12_TAG16_HKDF_SHA256_SIGNONE    := AlgSuite(CipherParams(AES256, 16, 12), Digests.HmacSHA256, None),
    AES_192_GCM_IV12_TAG16_HKDF_SHA256_SIGNONE    := AlgSuite(CipherParams(AES192, 16, 12), Digests.HmacSHA256, None),
    AES_128_GCM_IV12_TAG16_HKDF_SHA256_SIGNONE    := AlgSuite(CipherParams(AES128, 16, 12), Digests.HmacSHA256, None),
    AES_256_GCM_IV12_TAG16_KDFNONE_SIGNONE        := AlgSuite(CipherParams(AES256, 16, 12), Digests.HmacNOSHA,  None),
    AES_192_GCM_IV12_TAG16_KDFNONE_SIGNONE        := AlgSuite(CipherParams(AES192, 16, 12), Digests.HmacNOSHA,  None),
    AES_128_GCM_IV12_TAG16_KDFNONE_SIGNONE        := AlgSuite(CipherParams(AES128, 16, 12), Digests.HmacNOSHA,  None)
  ]
