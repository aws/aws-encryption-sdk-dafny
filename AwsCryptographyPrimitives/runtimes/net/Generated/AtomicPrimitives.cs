...
using System;
 ...
 public AtomicPrimitives(Dafny.Aws.Cryptography.Primitives.Types.IAwsCryptographicPrimitivesClient impl) {
    this._impl = impl;
}
 public Dafny.Aws.Cryptography.Primitives.Types.IAwsCryptographicPrimitivesClient impl() {
    return this._impl;
}
