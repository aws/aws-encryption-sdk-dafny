...
operation CreateBaseClientSupplier {
    input: CreateBaseClientSupplierInput,
    output: CreateBaseClientSupplierOutput
}

structure CreateBaseClientSupplierInput {
}

structure CreateBaseClientSupplierOutput {
