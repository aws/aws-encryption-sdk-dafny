...
public class HierarchicalMaterials {
  private final String branchKeyVersion;

  private final ByteBuffer branchKey;

  protected HierarchicalMaterials(BuilderImpl builder) {
  ...
  static class BuilderImpl implements Builder {
    ...
    protected BuilderImpl(HierarchicalMaterials model) {
    ...
    public HierarchicalMaterials build() {
      ...
      return new HierarchicalMaterials(this);
    }
  }
}
