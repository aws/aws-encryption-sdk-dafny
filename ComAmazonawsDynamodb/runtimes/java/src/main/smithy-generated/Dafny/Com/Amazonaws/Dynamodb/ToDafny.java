...
import Dafny.Com.Amazonaws.Dynamodb.Types.*;
...
public class ToDafny {
    public static BatchExecuteStatementOutput BatchExecuteStatementOutput(
            software.amazon.awssdk.services.dynamodb.model.BatchExecuteStatementResponse nativeValue) {
        Option<DafnySequence<? extends BatchStatementResponse>> responses;
        responses = Objects.nonNull(nativeValue.responses()) && !(nativeValue.responses() instanceof SdkAutoConstructList) ?
        ...
        consumedCapacity = Objects.nonNull(nativeValue.consumedCapacity()) && !(nativeValue.consumedCapacity() instanceof SdkAutoConstructList) ?
    ...
    public static BatchGetItemOutput BatchGetItemOutput(
            software.amazon.awssdk.services.dynamodb.model.BatchGetItemResponse nativeValue) {
        ...
        // SdkAutoConstructMap is the Java SDK's way to distinguish an explicitly empty map
        // vs a map that was not specified (and thus should be interpreted by us as null).
        // We need to check if this type is being passed in (here and elsewhere),
        // else we end up destroying this type information
        // and inadvertently signal to the SDK an explicitly empty map on the way out.
        responses = Objects.nonNull(nativeValue.responses()) && !(nativeValue.responses() instanceof SdkAutoConstructMap) ?
        ...
        unprocessedKeys = Objects.nonNull(nativeValue.unprocessedKeys()) && !(nativeValue.unprocessedKeys() instanceof SdkAutoConstructMap) ?
    ...
    public static BatchWriteItemOutput BatchWriteItemOutput(
            software.amazon.awssdk.services.dynamodb.model.BatchWriteItemResponse nativeValue) {
        Option<DafnyMap<? extends DafnySequence<? extends Character>, ? extends DafnySequence<? extends WriteRequest>>> unprocessedItems;
        unprocessedItems = Objects.nonNull(nativeValue.unprocessedItems()) && !(nativeValue.unprocessedItems() instanceof SdkAutoConstructMap) ?
        ...
        itemCollectionMetrics = Objects.nonNull(nativeValue.itemCollectionMetrics()) && !(nativeValue.itemCollectionMetrics() instanceof SdkAutoConstructMap) ?
    ...
    public static CreateBackupOutput CreateBackupOutput(
            software.amazon.awssdk.services.dynamodb.model.CreateBackupResponse nativeValue) {
    ...
    public static CreateGlobalTableOutput CreateGlobalTableOutput(
            software.amazon.awssdk.services.dynamodb.model.CreateGlobalTableResponse nativeValue) {
    ...
    public static CreateTableOutput CreateTableOutput(
            software.amazon.awssdk.services.dynamodb.model.CreateTableResponse nativeValue) {
    ...
    public static DeleteBackupOutput DeleteBackupOutput(
            software.amazon.awssdk.services.dynamodb.model.DeleteBackupResponse nativeValue) {
    ...
    public static DeleteItemOutput DeleteItemOutput(
            software.amazon.awssdk.services.dynamodb.model.DeleteItemResponse nativeValue) {
        Option<DafnyMap<? extends DafnySequence<? extends Character>, ? extends AttributeValue>> attributes;
        attributes = Objects.nonNull(nativeValue.attributes()) && !(nativeValue.attributes() instanceof SdkAutoConstructMap) ?
    ...
    public static DeleteTableOutput DeleteTableOutput(
            software.amazon.awssdk.services.dynamodb.model.DeleteTableResponse nativeValue) {
        Option<TableDescription> tableDescription;
        tableDescription = Objects.nonNull(nativeValue.tableDescription()) ?
                Option.create_Some(ToDafny.TableDescription(nativeValue.tableDescription()))
                : Option.create_None();
    ...
    public static DescribeBackupOutput DescribeBackupOutput(
            software.amazon.awssdk.services.dynamodb.model.DescribeBackupResponse nativeValue) {
        Option<BackupDescription> backupDescription;
        backupDescription = Objects.nonNull(nativeValue.backupDescription()) ?
                Option.create_Some(ToDafny.BackupDescription(nativeValue.backupDescription()))
                : Option.create_None();
    ...
    public static DescribeContinuousBackupsOutput DescribeContinuousBackupsOutput(
            software.amazon.awssdk.services.dynamodb.model.DescribeContinuousBackupsResponse nativeValue) {
    ...
    public static DescribeContributorInsightsOutput DescribeContributorInsightsOutput(
            software.amazon.awssdk.services.dynamodb.model.DescribeContributorInsightsResponse nativeValue) {
        ...
        contributorInsightsRuleList = Objects.nonNull(nativeValue.contributorInsightsRuleList()) && !(nativeValue.contributorInsightsRuleList() instanceof SdkAutoConstructList) ?
    ...
    public static DescribeExportOutput DescribeExportOutput(
            software.amazon.awssdk.services.dynamodb.model.DescribeExportResponse nativeValue) {
    ...
    public static DescribeGlobalTableOutput DescribeGlobalTableOutput(
            software.amazon.awssdk.services.dynamodb.model.DescribeGlobalTableResponse nativeValue) {
        Option<GlobalTableDescription> globalTableDescription;
        globalTableDescription = Objects.nonNull(nativeValue.globalTableDescription()) ?
                Option.create_Some(ToDafny.GlobalTableDescription(nativeValue.globalTableDescription()))
                : Option.create_None();
    ...
    public static DescribeGlobalTableSettingsOutput DescribeGlobalTableSettingsOutput(
            software.amazon.awssdk.services.dynamodb.model.DescribeGlobalTableSettingsResponse nativeValue) {
        ...
        replicaSettings = Objects.nonNull(nativeValue.replicaSettings()) && !(nativeValue.replicaSettings() instanceof SdkAutoConstructList) ?
    ...
    public static DescribeImportOutput DescribeImportOutput(
            software.amazon.awssdk.services.dynamodb.model.DescribeImportResponse nativeValue) {
    ...
    public static DescribeKinesisStreamingDestinationOutput DescribeKinesisStreamingDestinationOutput(
            software.amazon.awssdk.services.dynamodb.model.DescribeKinesisStreamingDestinationResponse nativeValue) {
        Option<DafnySequence<? extends Character>> tableName;
        tableName = Objects.nonNull(nativeValue.tableName()) ?
                Option.create_Some(software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName()))
                : Option.create_None();
        Option<DafnySequence<? extends KinesisDataStreamDestination>> kinesisDataStreamDestinations;
        kinesisDataStreamDestinations = Objects.nonNull(nativeValue.kinesisDataStreamDestinations()) && !(nativeValue.kinesisDataStreamDestinations() instanceof SdkAutoConstructList) ?
    ...
    public static DescribeLimitsOutput DescribeLimitsOutput(
            software.amazon.awssdk.services.dynamodb.model.DescribeLimitsResponse nativeValue) {
    ...
    public static DescribeTableOutput DescribeTableOutput(
            software.amazon.awssdk.services.dynamodb.model.DescribeTableResponse nativeValue) {
    ...
    public static DescribeTableReplicaAutoScalingOutput DescribeTableReplicaAutoScalingOutput(
            software.amazon.awssdk.services.dynamodb.model.DescribeTableReplicaAutoScalingResponse nativeValue) {
    ...
    public static DescribeTimeToLiveOutput DescribeTimeToLiveOutput(
            software.amazon.awssdk.services.dynamodb.model.DescribeTimeToLiveResponse nativeValue) {
    ...
    public static DisableKinesisStreamingDestinationOutput DisableKinesisStreamingDestinationOutput(
            software.amazon.awssdk.services.dynamodb.model.DisableKinesisStreamingDestinationResponse nativeValue) {
        Option<DafnySequence<? extends Character>> tableName;
        tableName = Objects.nonNull(nativeValue.tableName()) ?
                Option.create_Some(software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName()))
                : Option.create_None();
    ...
    public static EnableKinesisStreamingDestinationOutput EnableKinesisStreamingDestinationOutput(
            software.amazon.awssdk.services.dynamodb.model.EnableKinesisStreamingDestinationResponse nativeValue) {
        Option<DafnySequence<? extends Character>> tableName;
        tableName = Objects.nonNull(nativeValue.tableName()) ?
                Option.create_Some(software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName()))
                : Option.create_None();
    ...
    public static ExecuteStatementOutput ExecuteStatementOutput(
            software.amazon.awssdk.services.dynamodb.model.ExecuteStatementResponse nativeValue) {
        Option<DafnySequence<? extends DafnyMap<? extends DafnySequence<? extends Character>, ? extends AttributeValue>>> items;
        items = Objects.nonNull(nativeValue.items()) && !(nativeValue.items() instanceof SdkAutoConstructList) ?
        ...
        lastEvaluatedKey = Objects.nonNull(nativeValue.lastEvaluatedKey()) && !(nativeValue.lastEvaluatedKey() instanceof SdkAutoConstructMap) ?
    ...
    public static ExecuteTransactionOutput ExecuteTransactionOutput(
            software.amazon.awssdk.services.dynamodb.model.ExecuteTransactionResponse nativeValue) {
    ...
    public static ExportTableToPointInTimeOutput ExportTableToPointInTimeOutput(
            software.amazon.awssdk.services.dynamodb.model.ExportTableToPointInTimeResponse nativeValue) {
        Option<ExportDescription> exportDescription;
        exportDescription = Objects.nonNull(nativeValue.exportDescription()) ?
                Option.create_Some(ToDafny.ExportDescription(nativeValue.exportDescription()))
                : Option.create_None();
    ...
    public static GetItemOutput GetItemOutput(
            software.amazon.awssdk.services.dynamodb.model.GetItemResponse nativeValue) {
        Option<DafnyMap<? extends DafnySequence<? extends Character>, ? extends AttributeValue>> item;
        item = Objects.nonNull(nativeValue.item()) && !(nativeValue.item() instanceof SdkAutoConstructMap) ?
    ...
    public static ImportTableOutput ImportTableOutput(
            software.amazon.awssdk.services.dynamodb.model.ImportTableResponse nativeValue) {
        ImportTableDescription importTableDescription;
        importTableDescription = ToDafny.ImportTableDescription(nativeValue.importTableDescription());
    ...
    public static ListBackupsOutput ListBackupsOutput(
            software.amazon.awssdk.services.dynamodb.model.ListBackupsResponse nativeValue) {
        Option<DafnySequence<? extends BackupSummary>> backupSummaries;
        backupSummaries = Objects.nonNull(nativeValue.backupSummaries()) && !(nativeValue.backupSummaries() instanceof SdkAutoConstructList) ?
    ...
    public static ListContributorInsightsOutput ListContributorInsightsOutput(
            software.amazon.awssdk.services.dynamodb.model.ListContributorInsightsResponse nativeValue) {
        Option<DafnySequence<? extends ContributorInsightsSummary>> contributorInsightsSummaries;
        contributorInsightsSummaries = Objects.nonNull(nativeValue.contributorInsightsSummaries()) && !(nativeValue.contributorInsightsSummaries() instanceof SdkAutoConstructList) ?
    ...
    public static ListExportsOutput ListExportsOutput(
            software.amazon.awssdk.services.dynamodb.model.ListExportsResponse nativeValue) {
        Option<DafnySequence<? extends ExportSummary>> exportSummaries;
        exportSummaries = Objects.nonNull(nativeValue.exportSummaries()) && !(nativeValue.exportSummaries() instanceof SdkAutoConstructList) ?
    ...
    public static ListGlobalTablesOutput ListGlobalTablesOutput(
            software.amazon.awssdk.services.dynamodb.model.ListGlobalTablesResponse nativeValue) {
        Option<DafnySequence<? extends GlobalTable>> globalTables;
        globalTables = Objects.nonNull(nativeValue.globalTables()) && !(nativeValue.globalTables() instanceof SdkAutoConstructList) ?
    ...
    public static ListImportsOutput ListImportsOutput(
            software.amazon.awssdk.services.dynamodb.model.ListImportsResponse nativeValue) {
        Option<DafnySequence<? extends ImportSummary>> importSummaryList;
        importSummaryList = Objects.nonNull(nativeValue.importSummaryList()) && !(nativeValue.importSummaryList() instanceof SdkAutoConstructList) ?
    ...
    public static ListTablesOutput ListTablesOutput(
            software.amazon.awssdk.services.dynamodb.model.ListTablesResponse nativeValue) {
        Option<DafnySequence<? extends DafnySequence<? extends Character>>> tableNames;
        tableNames = Objects.nonNull(nativeValue.tableNames()) && !(nativeValue.tableNames() instanceof SdkAutoConstructList) ?
    ...
    public static ListTagsOfResourceOutput ListTagsOfResourceOutput(
            software.amazon.awssdk.services.dynamodb.model.ListTagsOfResourceResponse nativeValue) {
        Option<DafnySequence<? extends Tag>> tags;
        tags = Objects.nonNull(nativeValue.tags()) && !(nativeValue.tags() instanceof SdkAutoConstructList) ?
    ...
    public static PutItemOutput PutItemOutput(
            software.amazon.awssdk.services.dynamodb.model.PutItemResponse nativeValue) {
        Option<DafnyMap<? extends DafnySequence<? extends Character>, ? extends AttributeValue>> attributes;
        attributes = Objects.nonNull(nativeValue.attributes()) && !(nativeValue.attributes() instanceof SdkAutoConstructMap) ?
                Option.create_Some(ToDafny.AttributeMap(nativeValue.attributes()))
                : Option.create_None();
    ...
    public static QueryOutput QueryOutput(
            software.amazon.awssdk.services.dynamodb.model.QueryResponse nativeValue) {
        Option<DafnySequence<? extends DafnyMap<? extends DafnySequence<? extends Character>, ? extends AttributeValue>>> items;
        items = Objects.nonNull(nativeValue.items()) && !(nativeValue.items() instanceof SdkAutoConstructList) ?
                Option.create_Some(ToDafny.ItemList(nativeValue.items()))
                : Option.create_None();
    ...
    public static RestoreTableFromBackupOutput RestoreTableFromBackupOutput(
            software.amazon.awssdk.services.dynamodb.model.RestoreTableFromBackupResponse nativeValue) {
        Option<TableDescription> tableDescription;
        tableDescription = Objects.nonNull(nativeValue.tableDescription()) ?
                Option.create_Some(ToDafny.TableDescription(nativeValue.tableDescription()))
                : Option.create_None();
    ...
    public static RestoreTableToPointInTimeOutput RestoreTableToPointInTimeOutput(
            software.amazon.awssdk.services.dynamodb.model.RestoreTableToPointInTimeResponse nativeValue) {
        Option<TableDescription> tableDescription;
        tableDescription = Objects.nonNull(nativeValue.tableDescription()) ?
                Option.create_Some(ToDafny.TableDescription(nativeValue.tableDescription()))
                : Option.create_None();
    ...
    public static ScanOutput ScanOutput(
            software.amazon.awssdk.services.dynamodb.model.ScanResponse nativeValue) {
        Option<DafnySequence<? extends DafnyMap<? extends DafnySequence<? extends Character>, ? extends AttributeValue>>> items;
        items = Objects.nonNull(nativeValue.items()) && !(nativeValue.items() instanceof SdkAutoConstructList) ?
                Option.create_Some(ToDafny.ItemList(nativeValue.items()))
                : Option.create_None();
    ...
    public static TransactGetItemsOutput TransactGetItemsOutput(
            software.amazon.awssdk.services.dynamodb.model.TransactGetItemsResponse nativeValue) {
        Option<DafnySequence<? extends ConsumedCapacity>> consumedCapacity;
        consumedCapacity = Objects.nonNull(nativeValue.consumedCapacity()) && !(nativeValue.consumedCapacity() instanceof SdkAutoConstructList) ?
                Option.create_Some(ToDafny.ConsumedCapacityMultiple(nativeValue.consumedCapacity()))
                : Option.create_None();
    ...
    public static TransactWriteItemsOutput TransactWriteItemsOutput(
            software.amazon.awssdk.services.dynamodb.model.TransactWriteItemsResponse nativeValue) {
        Option<DafnySequence<? extends ConsumedCapacity>> consumedCapacity;
        consumedCapacity = Objects.nonNull(nativeValue.consumedCapacity()) && !(nativeValue.consumedCapacity() instanceof SdkAutoConstructList) ?
                Option.create_Some(ToDafny.ConsumedCapacityMultiple(nativeValue.consumedCapacity()))
                : Option.create_None();
    ...
    public static UpdateContinuousBackupsOutput UpdateContinuousBackupsOutput(
            software.amazon.awssdk.services.dynamodb.model.UpdateContinuousBackupsResponse nativeValue) {
        Option<ContinuousBackupsDescription> continuousBackupsDescription;
        continuousBackupsDescription = Objects.nonNull(nativeValue.continuousBackupsDescription()) ?
                Option.create_Some(ToDafny.ContinuousBackupsDescription(nativeValue.continuousBackupsDescription()))
                : Option.create_None();
    ...
    public static UpdateContributorInsightsOutput UpdateContributorInsightsOutput(
            software.amazon.awssdk.services.dynamodb.model.UpdateContributorInsightsResponse nativeValue) {
        Option<DafnySequence<? extends Character>> tableName;
        tableName = Objects.nonNull(nativeValue.tableName()) ?
                Option.create_Some(software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName()))
                : Option.create_None();
    ...
    public static UpdateGlobalTableOutput UpdateGlobalTableOutput(
            software.amazon.awssdk.services.dynamodb.model.UpdateGlobalTableResponse nativeValue) {
        Option<GlobalTableDescription> globalTableDescription;
        globalTableDescription = Objects.nonNull(nativeValue.globalTableDescription()) ?
                Option.create_Some(ToDafny.GlobalTableDescription(nativeValue.globalTableDescription()))
                : Option.create_None();
    ...
    public static UpdateGlobalTableSettingsOutput UpdateGlobalTableSettingsOutput(
            software.amazon.awssdk.services.dynamodb.model.UpdateGlobalTableSettingsResponse nativeValue) {
        Option<DafnySequence<? extends Character>> globalTableName;
        globalTableName = Objects.nonNull(nativeValue.globalTableName()) ?
                Option.create_Some(software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.globalTableName()))
                : Option.create_None();
    ...
    public static UpdateItemOutput UpdateItemOutput(
            software.amazon.awssdk.services.dynamodb.model.UpdateItemResponse nativeValue) {
        Option<DafnyMap<? extends DafnySequence<? extends Character>, ? extends AttributeValue>> attributes;
        attributes = Objects.nonNull(nativeValue.attributes()) && !(nativeValue.attributes() instanceof SdkAutoConstructMap) ?
                Option.create_Some(ToDafny.AttributeMap(nativeValue.attributes()))
                : Option.create_None();
    ...
    public static UpdateTableOutput UpdateTableOutput(
            software.amazon.awssdk.services.dynamodb.model.UpdateTableResponse nativeValue) {
        Option<TableDescription> tableDescription;
        tableDescription = Objects.nonNull(nativeValue.tableDescription()) ?
                Option.create_Some(ToDafny.TableDescription(nativeValue.tableDescription()))
                : Option.create_None();
    ...
    public static UpdateTableReplicaAutoScalingOutput UpdateTableReplicaAutoScalingOutput(
            software.amazon.awssdk.services.dynamodb.model.UpdateTableReplicaAutoScalingResponse nativeValue) {
        Option<TableAutoScalingDescription> tableAutoScalingDescription;
        tableAutoScalingDescription = Objects.nonNull(nativeValue.tableAutoScalingDescription()) ?
                Option.create_Some(ToDafny.TableAutoScalingDescription(nativeValue.tableAutoScalingDescription()))
                : Option.create_None();
    ...
    public static UpdateTimeToLiveOutput UpdateTimeToLiveOutput(
            software.amazon.awssdk.services.dynamodb.model.UpdateTimeToLiveResponse nativeValue) {
    ...
    public static BatchExecuteStatementInput BatchExecuteStatementInput(
            software.amazon.awssdk.services.dynamodb.model.BatchExecuteStatementRequest nativeValue) {
    ...
    public static BatchGetItemInput BatchGetItemInput(
            software.amazon.awssdk.services.dynamodb.model.BatchGetItemRequest nativeValue) {
    ...
    public static BatchWriteItemInput BatchWriteItemInput(
            software.amazon.awssdk.services.dynamodb.model.BatchWriteItemRequest nativeValue) {
    ...
    public static CreateBackupInput CreateBackupInput(
            software.amazon.awssdk.services.dynamodb.model.CreateBackupRequest nativeValue) {
    ...
    public static CreateGlobalTableInput CreateGlobalTableInput(
            software.amazon.awssdk.services.dynamodb.model.CreateGlobalTableRequest nativeValue) {
    ...
    public static CreateTableInput CreateTableInput(
            software.amazon.awssdk.services.dynamodb.model.CreateTableRequest nativeValue) {
        ...
        localSecondaryIndexes = Objects.nonNull(nativeValue.localSecondaryIndexes()) && !(nativeValue.localSecondaryIndexes() instanceof SdkAutoConstructList) ?
        ...
        globalSecondaryIndexes = Objects.nonNull(nativeValue.globalSecondaryIndexes()) && !(nativeValue.globalSecondaryIndexes() instanceof SdkAutoConstructList) ?
    ...
    public static DeleteBackupInput DeleteBackupInput(
            software.amazon.awssdk.services.dynamodb.model.DeleteBackupRequest nativeValue) {
    ...
    public static DeleteItemInput DeleteItemInput(
            software.amazon.awssdk.services.dynamodb.model.DeleteItemRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
        ...
        expected = Objects.nonNull(nativeValue.expected()) && !(nativeValue.expected() instanceof SdkAutoConstructMap) ?
        ...
        expressionAttributeNames = Objects.nonNull(nativeValue.expressionAttributeNames()) && !(nativeValue.expressionAttributeNames() instanceof SdkAutoConstructMap) ?
        ...
        expressionAttributeValues = Objects.nonNull(nativeValue.expressionAttributeValues()) && !(nativeValue.expressionAttributeValues() instanceof SdkAutoConstructMap) ?
    ...
    public static DeleteTableInput DeleteTableInput(
            software.amazon.awssdk.services.dynamodb.model.DeleteTableRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
    ...
    public static DescribeBackupInput DescribeBackupInput(
            software.amazon.awssdk.services.dynamodb.model.DescribeBackupRequest nativeValue) {
        DafnySequence<? extends Character> backupArn;
        backupArn = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.backupArn());
    ...
    public static DescribeContinuousBackupsInput DescribeContinuousBackupsInput(
            software.amazon.awssdk.services.dynamodb.model.DescribeContinuousBackupsRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
    ...
    public static DescribeContributorInsightsInput DescribeContributorInsightsInput(
            software.amazon.awssdk.services.dynamodb.model.DescribeContributorInsightsRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
        Option<DafnySequence<? extends Character>> indexName;
        indexName = Objects.nonNull(nativeValue.indexName()) ?
    ...
    public static DescribeExportInput DescribeExportInput(
            software.amazon.awssdk.services.dynamodb.model.DescribeExportRequest nativeValue) {
    ...
    public static DescribeGlobalTableInput DescribeGlobalTableInput(
            software.amazon.awssdk.services.dynamodb.model.DescribeGlobalTableRequest nativeValue) {
        DafnySequence<? extends Character> globalTableName;
        globalTableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.globalTableName());
    ...
    public static DescribeGlobalTableSettingsInput DescribeGlobalTableSettingsInput(
            software.amazon.awssdk.services.dynamodb.model.DescribeGlobalTableSettingsRequest nativeValue) {
        DafnySequence<? extends Character> globalTableName;
        globalTableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.globalTableName());
    ...
    public static DescribeImportInput DescribeImportInput(
            software.amazon.awssdk.services.dynamodb.model.DescribeImportRequest nativeValue) {
    ...
    public static DescribeKinesisStreamingDestinationInput DescribeKinesisStreamingDestinationInput(
            software.amazon.awssdk.services.dynamodb.model.DescribeKinesisStreamingDestinationRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
    ...
    public static DescribeLimitsInput DescribeLimitsInput(
            software.amazon.awssdk.services.dynamodb.model.DescribeLimitsRequest nativeValue) {
        return new DescribeLimitsInput();
    }

    public static DescribeTableInput DescribeTableInput(
            software.amazon.awssdk.services.dynamodb.model.DescribeTableRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
    ...
    public static DescribeTableReplicaAutoScalingInput DescribeTableReplicaAutoScalingInput(
            software.amazon.awssdk.services.dynamodb.model.DescribeTableReplicaAutoScalingRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
    ...
    public static DescribeTimeToLiveInput DescribeTimeToLiveInput(
            software.amazon.awssdk.services.dynamodb.model.DescribeTimeToLiveRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
    ...
    public static DisableKinesisStreamingDestinationInput DisableKinesisStreamingDestinationInput(
            software.amazon.awssdk.services.dynamodb.model.DisableKinesisStreamingDestinationRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
    ...
    public static EnableKinesisStreamingDestinationInput EnableKinesisStreamingDestinationInput(
            software.amazon.awssdk.services.dynamodb.model.EnableKinesisStreamingDestinationRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
        DafnySequence<? extends Character> streamArn;
        streamArn = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.streamArn());
    ...
    public static ExecuteStatementInput ExecuteStatementInput(
            software.amazon.awssdk.services.dynamodb.model.ExecuteStatementRequest nativeValue) {
        ...
        parameters = Objects.nonNull(nativeValue.parameters()) && !(nativeValue.parameters() instanceof SdkAutoConstructList) ?
    ...
    public static ExecuteTransactionInput ExecuteTransactionInput(
            software.amazon.awssdk.services.dynamodb.model.ExecuteTransactionRequest nativeValue) {
    ...
    public static ExportTableToPointInTimeInput ExportTableToPointInTimeInput(
            software.amazon.awssdk.services.dynamodb.model.ExportTableToPointInTimeRequest nativeValue) {
    ...
    public static GetItemInput GetItemInput(
            software.amazon.awssdk.services.dynamodb.model.GetItemRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
        DafnyMap<? extends DafnySequence<? extends Character>, ? extends AttributeValue> key;
        key = ToDafny.Key(nativeValue.key());
        Option<DafnySequence<? extends DafnySequence<? extends Character>>> attributesToGet;
        attributesToGet = Objects.nonNull(nativeValue.attributesToGet()) && !(nativeValue.attributesToGet() instanceof SdkAutoConstructList) ?
    ...
    public static ImportTableInput ImportTableInput(
            software.amazon.awssdk.services.dynamodb.model.ImportTableRequest nativeValue) {
        Option<DafnySequence<? extends Character>> clientToken;
        clientToken = Objects.nonNull(nativeValue.clientToken()) ?
                Option.create_Some(software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.clientToken()))
                : Option.create_None();
    ...
    public static ListBackupsInput ListBackupsInput(
            software.amazon.awssdk.services.dynamodb.model.ListBackupsRequest nativeValue) {
        Option<DafnySequence<? extends Character>> tableName;
        tableName = Objects.nonNull(nativeValue.tableName()) ?
                Option.create_Some(software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName()))
                : Option.create_None();
    ...
    public static ListContributorInsightsInput ListContributorInsightsInput(
            software.amazon.awssdk.services.dynamodb.model.ListContributorInsightsRequest nativeValue) {
        Option<DafnySequence<? extends Character>> tableName;
        tableName = Objects.nonNull(nativeValue.tableName()) ?
                Option.create_Some(software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName()))
                : Option.create_None();
    ...
    public static ListExportsInput ListExportsInput(
            software.amazon.awssdk.services.dynamodb.model.ListExportsRequest nativeValue) {
    ...
    public static ListGlobalTablesInput ListGlobalTablesInput(
            software.amazon.awssdk.services.dynamodb.model.ListGlobalTablesRequest nativeValue) {
    ...
    public static ListImportsInput ListImportsInput(
            software.amazon.awssdk.services.dynamodb.model.ListImportsRequest nativeValue) {
        Option<DafnySequence<? extends Character>> tableArn;
        tableArn = Objects.nonNull(nativeValue.tableArn()) ?
                Option.create_Some(software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableArn()))
                : Option.create_None();
    ...
    public static ListTablesInput ListTablesInput(
            software.amazon.awssdk.services.dynamodb.model.ListTablesRequest nativeValue) {
    ...
    public static ListTagsOfResourceInput ListTagsOfResourceInput(
            software.amazon.awssdk.services.dynamodb.model.ListTagsOfResourceRequest nativeValue) {
    ...
    public static PutItemInput PutItemInput(
            software.amazon.awssdk.services.dynamodb.model.PutItemRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
    ...
    public static QueryInput QueryInput(
            software.amazon.awssdk.services.dynamodb.model.QueryRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
        Option<DafnySequence<? extends Character>> indexName;
        indexName = Objects.nonNull(nativeValue.indexName()) ?
        ...
        keyConditions = Objects.nonNull(nativeValue.keyConditions()) && !(nativeValue.keyConditions() instanceof SdkAutoConstructMap) ?
        ...
        queryFilter = Objects.nonNull(nativeValue.queryFilter()) && !(nativeValue.queryFilter() instanceof SdkAutoConstructMap) ?
        ...
        exclusiveStartKey = Objects.nonNull(nativeValue.exclusiveStartKey()) && !(nativeValue.exclusiveStartKey() instanceof SdkAutoConstructMap) ?
    ...
    public static RestoreTableFromBackupInput RestoreTableFromBackupInput(
            software.amazon.awssdk.services.dynamodb.model.RestoreTableFromBackupRequest nativeValue) {
        ...
        globalSecondaryIndexOverride = Objects.nonNull(nativeValue.globalSecondaryIndexOverride()) && !(nativeValue.globalSecondaryIndexOverride() instanceof SdkAutoConstructList) ?
        ...
        localSecondaryIndexOverride = Objects.nonNull(nativeValue.localSecondaryIndexOverride()) && !(nativeValue.localSecondaryIndexOverride() instanceof SdkAutoConstructList) ?
    ...
    public static RestoreTableToPointInTimeInput RestoreTableToPointInTimeInput(
            software.amazon.awssdk.services.dynamodb.model.RestoreTableToPointInTimeRequest nativeValue) {
    ...
    public static ScanInput ScanInput(software.amazon.awssdk.services.dynamodb.model.ScanRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
        Option<DafnySequence<? extends Character>> indexName;
        indexName = Objects.nonNull(nativeValue.indexName()) ?
        ...
        scanFilter = Objects.nonNull(nativeValue.scanFilter()) && !(nativeValue.scanFilter() instanceof SdkAutoConstructMap) ?
    ...
    public static TagResourceInput TagResourceInput(
            software.amazon.awssdk.services.dynamodb.model.TagResourceRequest nativeValue) {
        DafnySequence<? extends Character> resourceArn;
        resourceArn = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.resourceArn());
    ...
    public static TransactGetItemsInput TransactGetItemsInput(
            software.amazon.awssdk.services.dynamodb.model.TransactGetItemsRequest nativeValue) {
    ...
    public static TransactWriteItemsInput TransactWriteItemsInput(
            software.amazon.awssdk.services.dynamodb.model.TransactWriteItemsRequest nativeValue) {
    ...
    public static UntagResourceInput UntagResourceInput(
            software.amazon.awssdk.services.dynamodb.model.UntagResourceRequest nativeValue) {
        DafnySequence<? extends Character> resourceArn;
        resourceArn = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.resourceArn());
    ...
    public static UpdateContinuousBackupsInput UpdateContinuousBackupsInput(
            software.amazon.awssdk.services.dynamodb.model.UpdateContinuousBackupsRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
    ...
    public static UpdateContributorInsightsInput UpdateContributorInsightsInput(
            software.amazon.awssdk.services.dynamodb.model.UpdateContributorInsightsRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
        Option<DafnySequence<? extends Character>> indexName;
        indexName = Objects.nonNull(nativeValue.indexName()) ?
    ...
    public static UpdateGlobalTableInput UpdateGlobalTableInput(
            software.amazon.awssdk.services.dynamodb.model.UpdateGlobalTableRequest nativeValue) {
        DafnySequence<? extends Character> globalTableName;
        globalTableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.globalTableName());
    ...
    public static UpdateGlobalTableSettingsInput UpdateGlobalTableSettingsInput(
            software.amazon.awssdk.services.dynamodb.model.UpdateGlobalTableSettingsRequest nativeValue) {
        DafnySequence<? extends Character> globalTableName;
        globalTableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.globalTableName());
        ...
        globalTableGlobalSecondaryIndexSettingsUpdate = Objects.nonNull(nativeValue.globalTableGlobalSecondaryIndexSettingsUpdate()) && !(nativeValue.globalTableGlobalSecondaryIndexSettingsUpdate() instanceof SdkAutoConstructList) ?
        ...
        replicaSettingsUpdate = Objects.nonNull(nativeValue.replicaSettingsUpdate()) && !(nativeValue.replicaSettingsUpdate() instanceof SdkAutoConstructList) ?
    ...
    public static UpdateItemInput UpdateItemInput(
            software.amazon.awssdk.services.dynamodb.model.UpdateItemRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
        DafnyMap<? extends DafnySequence<? extends Character>, ? extends AttributeValue> key;
        key = ToDafny.Key(nativeValue.key());
        Option<DafnyMap<? extends DafnySequence<? extends Character>, ? extends AttributeValueUpdate>> attributeUpdates;
        attributeUpdates = Objects.nonNull(nativeValue.attributeUpdates()) && !(nativeValue.attributeUpdates() instanceof SdkAutoConstructMap) ?
    ...
    public static UpdateTableInput UpdateTableInput(
            software.amazon.awssdk.services.dynamodb.model.UpdateTableRequest nativeValue) {
        Option<DafnySequence<? extends AttributeDefinition>> attributeDefinitions;
        attributeDefinitions = Objects.nonNull(nativeValue.attributeDefinitions()) && !(nativeValue.attributeDefinitions() instanceof SdkAutoConstructList) ?
        ...
        globalSecondaryIndexUpdates = Objects.nonNull(nativeValue.globalSecondaryIndexUpdates()) && !(nativeValue.globalSecondaryIndexUpdates() instanceof SdkAutoConstructList) ?
        ...
        replicaUpdates = Objects.nonNull(nativeValue.replicaUpdates()) && !(nativeValue.replicaUpdates() instanceof SdkAutoConstructList) ?
    ...
    public static UpdateTableReplicaAutoScalingInput UpdateTableReplicaAutoScalingInput(
            software.amazon.awssdk.services.dynamodb.model.UpdateTableReplicaAutoScalingRequest nativeValue) {
    ...
    public static UpdateTimeToLiveInput UpdateTimeToLiveInput(
            software.amazon.awssdk.services.dynamodb.model.UpdateTimeToLiveRequest nativeValue) {
        DafnySequence<? extends Character> tableName;
        tableName = software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName());
    ...
    public static GlobalTableDescription GlobalTableDescription(
        ...
        replicationGroup = Objects.nonNull(nativeValue.replicationGroup()) && !(nativeValue.replicationGroup() instanceof SdkAutoConstructList) ?
    ...
    public static TableDescription TableDescription(
        ...
        keySchema = Objects.nonNull(nativeValue.keySchema()) && !(nativeValue.keySchema() instanceof SdkAutoConstructList) ?
        ...
        replicas = Objects.nonNull(nativeValue.replicas()) && !(nativeValue.replicas() instanceof SdkAutoConstructList) ?
    ...
    public static ConsumedCapacity ConsumedCapacity(
        ...
        tableName = Objects.nonNull(nativeValue.tableName()) ?
                Option.create_Some(software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.tableName()))
                : Option.create_None();
        Option<Integer> capacityUnits;
        capacityUnits = Objects.nonNull(nativeValue.capacityUnits()) ?
                Option.create_Some(Integer.valueOf(nativeValue.capacityUnits().intValue()))
                : Option.create_None();
        Option<Integer> readCapacityUnits;
        readCapacityUnits = Objects.nonNull(nativeValue.readCapacityUnits()) ?
                Option.create_Some(Integer.valueOf(nativeValue.readCapacityUnits().intValue()))
                : Option.create_None();
        Option<Integer> writeCapacityUnits;
        writeCapacityUnits = Objects.nonNull(nativeValue.writeCapacityUnits()) ?
                Option.create_Some(Integer.valueOf(nativeValue.writeCapacityUnits().intValue()))
                : Option.create_None();
        ...
        localSecondaryIndexes = Objects.nonNull(nativeValue.localSecondaryIndexes()) && !(nativeValue.localSecondaryIndexes() instanceof SdkAutoConstructMap) ?
        ...
        globalSecondaryIndexes = Objects.nonNull(nativeValue.globalSecondaryIndexes()) && !(nativeValue.globalSecondaryIndexes() instanceof SdkAutoConstructMap) ?
    ...
    public static ItemCollectionMetrics ItemCollectionMetrics(
        ...
        itemCollectionKey = Objects.nonNull(nativeValue.itemCollectionKey()) && !(nativeValue.itemCollectionKey() instanceof SdkAutoConstructMap) ?
                Option.create_Some(ToDafny.ItemCollectionKeyAttributeMap(nativeValue.itemCollectionKey()))
                : Option.create_None();
        Option<DafnySequence<? extends Integer>> sizeEstimateRangeGB;
        sizeEstimateRangeGB = Objects.nonNull(nativeValue.sizeEstimateRangeGB()) && !(nativeValue.sizeEstimateRangeGB() instanceof SdkAutoConstructList) ?
                Option.create_Some(ToDafny.ItemCollectionSizeEstimateRange(nativeValue.sizeEstimateRangeGB().stream().map(val -> Integer.valueOf(val.intValue())).collect(Collectors.toList())))
                : Option.create_None();
    ...
    public static DafnySequence<? extends DafnyMap<? extends DafnySequence<? extends Character>, ? extends AttributeValue>> ItemList(
        ...
        return software.amazon.dafny.conversion.ToDafny.Aggregate.GenericToSequence(
                ...
                dafny.DafnyMap._typeDescriptor(DafnySequence._typeDescriptor(TypeDescriptor.CHAR), AttributeValue._typeDescriptor()));
    }
    ...
    public static AttributeValue AttributeValue(
        ...
        if (Objects.nonNull(nativeValue.b())) {
            // TODO Figure out how to correctly copy byte arrays over without breaking ReadOnlyByteBuffer
            return AttributeValue.create_B(software.amazon.dafny.conversion.ToDafny.Simple.ByteSequence(ByteBuffer.wrap(nativeValue.b().asByteArray())));
        }
        // TODO Correctly gen code for when the SDK represents empty lists/map
        if (Objects.nonNull(nativeValue.ss()) && !(nativeValue.ss() instanceof DefaultSdkAutoConstructList)) {
            return AttributeValue.create_SS(ToDafny.StringSetAttributeValue(nativeValue.ss()));
        }
        if (Objects.nonNull(nativeValue.ns()) && !(nativeValue.ns() instanceof DefaultSdkAutoConstructList)) {
            return AttributeValue.create_NS(ToDafny.NumberSetAttributeValue(nativeValue.ns()));
        }
        if (Objects.nonNull(nativeValue.bs()) && !(nativeValue.bs() instanceof DefaultSdkAutoConstructList)) {
            // TODO Figure out how to correctly copy byte arrays over without breaking ReadOnlyByteBuffer
            return AttributeValue.create_BS(ToDafny.BinarySetAttributeValue(nativeValue.bs().stream().map(val -> ByteBuffer.wrap(val.asByteArray())).collect(Collectors.toList())));
        }
        if (Objects.nonNull(nativeValue.m()) && !(nativeValue.m() instanceof DefaultSdkAutoConstructMap)) {
            return AttributeValue.create_M(ToDafny.MapAttributeValue(nativeValue.m()));
        }
        if (Objects.nonNull(nativeValue.l()) && !(nativeValue.l() instanceof DefaultSdkAutoConstructList)) {
    ...
    public static Capacity Capacity(software.amazon.awssdk.services.dynamodb.model.Capacity nativeValue) {
        Option<Integer> readCapacityUnits;
        readCapacityUnits = Objects.nonNull(nativeValue.readCapacityUnits()) ?
                Option.create_Some(Integer.valueOf(nativeValue.readCapacityUnits().intValue()))
                : Option.create_None();
    ...
    public static DafnySequence<? extends Integer> ItemCollectionSizeEstimateRange(
            List<Integer> nativeValue) {
        return software.amazon.dafny.conversion.ToDafny.Aggregate.GenericToSequence(
                nativeValue,
                Function.identity(),
                TypeDescriptor.INT);
    ...
    public static Endpoint Endpoint(software.amazon.awssdk.services.dynamodb.model.Endpoint nativeValue) {
    ...
    public static ReplicaSettingsDescription ReplicaSettingsDescription(
        ...
        replicaGlobalSecondaryIndexSettings = Objects.nonNull(nativeValue.replicaGlobalSecondaryIndexSettings()) && !(nativeValue.replicaGlobalSecondaryIndexSettings() instanceof SdkAutoConstructList) ?
    ...
    public static Replica Replica(software.amazon.awssdk.services.dynamodb.model.Replica nativeValue) {
        Option<DafnySequence<? extends Character>> regionName;
        regionName = Objects.nonNull(nativeValue.regionName()) ?
                Option.create_Some(software.amazon.dafny.conversion.ToDafny.Simple.CharacterSequence(nativeValue.regionName()))
                : Option.create_None();
    ...
    public static ExpectedAttributeValue ExpectedAttributeValue(
        ...
        attributeValueList = Objects.nonNull(nativeValue.attributeValueList()) && !(nativeValue.attributeValueList() instanceof SdkAutoConstructList) ?
    ...
    public static CsvOptions CsvOptions(
        ...
        headerList = Objects.nonNull(nativeValue.headerList()) && !(nativeValue.headerList() instanceof SdkAutoConstructList) ?
                Option.create_Some(ToDafny.CsvHeaderList(nativeValue.headerList()))
                : Option.create_None();
        return new CsvOptions(delimiter, headerList);
    }

    public static Condition Condition(software.amazon.awssdk.services.dynamodb.model.Condition nativeValue) {
        Option<DafnySequence<? extends AttributeValue>> attributeValueList;
        attributeValueList = Objects.nonNull(nativeValue.attributeValueList()) && !(nativeValue.attributeValueList() instanceof SdkAutoConstructList) ?
                Option.create_Some(ToDafny.AttributeValueList(nativeValue.attributeValueList()))
                : Option.create_None();
    ...
    public static ReplicaSettingsUpdate ReplicaSettingsUpdate(
        ...
        replicaGlobalSecondaryIndexSettingsUpdate = Objects.nonNull(nativeValue.replicaGlobalSecondaryIndexSettingsUpdate()) && !(nativeValue.replicaGlobalSecondaryIndexSettingsUpdate() instanceof SdkAutoConstructList) ?
    ...
    public static ReplicaAutoScalingUpdate ReplicaAutoScalingUpdate(
        ...
        replicaGlobalSecondaryIndexUpdates = Objects.nonNull(nativeValue.replicaGlobalSecondaryIndexUpdates()) && !(nativeValue.replicaGlobalSecondaryIndexUpdates() instanceof SdkAutoConstructList) ?
    ...
    public static AutoScalingSettingsDescription AutoScalingSettingsDescription(
        ...
        scalingPolicies = Objects.nonNull(nativeValue.scalingPolicies()) && !(nativeValue.scalingPolicies() instanceof SdkAutoConstructList) ?
    ...
    public static Projection Projection(
        ...
        nonKeyAttributes = Objects.nonNull(nativeValue.nonKeyAttributes()) && !(nativeValue.nonKeyAttributes() instanceof SdkAutoConstructList) ?
    ...
    public static AutoScalingTargetTrackingScalingPolicyConfigurationUpdate AutoScalingTargetTrackingScalingPolicyConfigurationUpdate(
        ...
        scaleOutCooldown = Objects.nonNull(nativeValue.scaleOutCooldown()) ?
                ...
                : Option.create_None();
        Integer targetValue;
        targetValue = Integer.valueOf(nativeValue.targetValue().intValue());
    ...
    public static Error Error(TransactionCanceledException nativeValue) {
        ...
        cancellationReasons = Objects.nonNull(nativeValue.cancellationReasons()) && !(nativeValue.cancellationReasons() instanceof SdkAutoConstructList) ?
    ...
    public static SSEType SSEType(software.amazon.awssdk.services.dynamodb.model.SSEType nativeValue) {
        switch (nativeValue) {
            case AES256: {
    ...
    public static SSEStatus SSEStatus(software.amazon.awssdk.services.dynamodb.model.SSEStatus nativeValue) {
        switch (nativeValue) {
            case ENABLING: {
    ...
    public static KeyType KeyType(software.amazon.awssdk.services.dynamodb.model.KeyType nativeValue) {
        switch (nativeValue) {
            case HASH: {
