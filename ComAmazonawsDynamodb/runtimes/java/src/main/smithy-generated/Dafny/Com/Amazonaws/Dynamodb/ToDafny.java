...
public class ToDafny {
  ...
  public static AttributeValue AttributeValue(
    ...
    if (Objects.nonNull(nativeValue.b())) {
      return AttributeValue.create_B(software.amazon.dafny.conversion.ToDafny.Simple.ByteSequence(nativeValue.b().asByteBuffer()));
    }
    ...
    if (Objects.nonNull(nativeValue.bs())) {
      return AttributeValue.create_BS(ToDafny.BinarySetAttributeValue(nativeValue.bs().stream().map(val -> val.asByteBuffer()).collect(Collectors.toList())));
    }
