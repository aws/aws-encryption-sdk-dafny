...
impl DecryptInput {
    /// Creates a new builder-style object to manufacture [`DecryptInput`](crate::operation::decrypt::builders::DecryptInput).
...
/// A builder for [`DecryptInput`](crate::operation::operation::DecryptInput).
#[non_exhaustive]
#[derive(
...
pub fn get_materials_manager(&self) -> &::std::option::Option<crate::deps::aws_cryptography_materialProviders::types::cryptographic_materials_manager::CryptographicMaterialsManagerRef> {
    ...
    /// Consumes the builder and constructs a [`DecryptInput`](crate::operation::operation::DecryptInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
