...
impl EncryptOutput {
    /// Creates a new builder-style object to manufacture [`EncryptOutput`](crate::types::EncryptOutput).
    pub fn builder() -> crate::types::builders::EncryptOutputBuilder {
        crate::types::builders::EncryptOutputBuilder::default()
    }
}

/// A builder for [`EncryptOutput`](crate::types::EncryptOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_encryption_context(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`EncryptOutput`](crate::types::EncryptOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::types::EncryptOutput {
