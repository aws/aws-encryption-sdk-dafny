...
impl EncryptInput {
    /// Creates a new builder-style object to manufacture [`EncryptInput`](crate::types::EncryptInput).
    pub fn builder() -> crate::types::builders::EncryptInputBuilder {
        crate::types::builders::EncryptInputBuilder::default()
    }
}

/// A builder for [`EncryptInput`](crate::types::EncryptInput).
#[non_exhaustive]
#[derive(
...
pub fn get_plaintext(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`EncryptInput`](crate::types::EncryptInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::types::EncryptInput {
