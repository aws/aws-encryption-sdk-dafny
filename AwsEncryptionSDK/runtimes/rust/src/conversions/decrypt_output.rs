...
#[allow(dead_code)]
pub fn to_dafny(
    value: &crate::types::DecryptOutput,
) -> ::std::rc::Rc<
...
pub fn to_dafny_plain(
    ...
    crate::r#software::amazon::cryptography::encryptionsdk::internaldafny::types::DecryptOutput::DecryptOutput {
...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::types::DecryptOutput>,
...
pub fn plain_from_dafny(
    dafny_value: &crate::r#software::amazon::cryptography::encryptionsdk::internaldafny::types::DecryptOutput,
) -> crate::types::DecryptOutput {
    match dafny_value {
        crate::r#software::amazon::cryptography::encryptionsdk::internaldafny::types::DecryptOutput::DecryptOutput {..} =>
            crate::types::DecryptOutput::builder()
...
pub fn option_from_dafny(
    dafny_value: ::std::rc::Rc<crate::_Wrappers_Compile::Option<::std::rc::Rc<
        crate::r#software::amazon::cryptography::encryptionsdk::internaldafny::types::DecryptOutput,
    >>>,
) -> ::std::option::Option<crate::types::DecryptOutput> {
    match &*dafny_value {
