...
impl CreateMultiKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateMultiKeyringInput`](crate::deps::aws_cryptography_materialProviders::types::CreateMultiKeyringInput).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::types::builders::CreateMultiKeyringInputBuilder {
        crate::deps::aws_cryptography_materialProviders::types::builders::CreateMultiKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateMultiKeyringInput`](crate::deps::aws_cryptography_materialProviders::types::CreateMultiKeyringInput).
#[non_exhaustive]
#[derive(
...
pub fn get_generator(&self) -> &::std::option::Option<crate::deps::aws_cryptography_materialProviders::types::keyring::KeyringRef> {
    ...
    /// Consumes the builder and constructs a [`CreateMultiKeyringInput`](crate::deps::aws_cryptography_materialProviders::types::CreateMultiKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_materialProviders::types::CreateMultiKeyringInput {
