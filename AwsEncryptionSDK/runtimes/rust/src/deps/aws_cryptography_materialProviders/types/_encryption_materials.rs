...
impl EncryptionMaterials {
    /// Creates a new builder-style object to manufacture [`EncryptionMaterials`](crate::deps::aws_cryptography_materialProviders::types::EncryptionMaterials).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::types::builders::EncryptionMaterialsBuilder {
        crate::deps::aws_cryptography_materialProviders::types::builders::EncryptionMaterialsBuilder::default()
    }
}

/// A builder for [`EncryptionMaterials`](crate::deps::aws_cryptography_materialProviders::types::EncryptionMaterials).
#[non_exhaustive]
#[derive(
...
pub fn get_symmetric_signing_keys(&self) -> &::std::option::Option<::std::vec::Vec<::aws_smithy_types::Blob>> {
    ...
    /// Consumes the builder and constructs a [`EncryptionMaterials`](crate::deps::aws_cryptography_materialProviders::types::EncryptionMaterials).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_materialProviders::types::EncryptionMaterials {
