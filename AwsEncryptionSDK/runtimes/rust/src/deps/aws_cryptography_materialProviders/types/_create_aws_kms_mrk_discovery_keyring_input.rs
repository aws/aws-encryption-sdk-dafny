...
impl CreateAwsKmsMrkDiscoveryKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsMrkDiscoveryKeyringInput`](crate::deps::aws_cryptography_materialProviders::types::CreateAwsKmsMrkDiscoveryKeyringInput).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::types::builders::CreateAwsKmsMrkDiscoveryKeyringInputBuilder {
        crate::deps::aws_cryptography_materialProviders::types::builders::CreateAwsKmsMrkDiscoveryKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsMrkDiscoveryKeyringInput`](crate::deps::aws_cryptography_materialProviders::types::CreateAwsKmsMrkDiscoveryKeyringInput).
#[non_exhaustive]
#[derive(
...
pub fn get_region(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsMrkDiscoveryKeyringInput`](crate::deps::aws_cryptography_materialProviders::types::CreateAwsKmsMrkDiscoveryKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_materialProviders::types::CreateAwsKmsMrkDiscoveryKeyringInput {
