...
impl ValidateCommitmentPolicyOnDecryptInput {
    /// Creates a new builder-style object to manufacture [`ValidateCommitmentPolicyOnDecryptInput`](crate::deps::aws_cryptography_materialProviders::types::ValidateCommitmentPolicyOnDecryptInput).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::types::builders::ValidateCommitmentPolicyOnDecryptInputBuilder {
        crate::deps::aws_cryptography_materialProviders::types::builders::ValidateCommitmentPolicyOnDecryptInputBuilder::default()
    }
}

/// A builder for [`ValidateCommitmentPolicyOnDecryptInput`](crate::deps::aws_cryptography_materialProviders::types::ValidateCommitmentPolicyOnDecryptInput).
#[non_exhaustive]
#[derive(
...
pub fn get_commitment_policy(&self) -> &::std::option::Option<crate::deps::aws_cryptography_materialProviders::types::CommitmentPolicy> {
    ...
    /// Consumes the builder and constructs a [`ValidateCommitmentPolicyOnDecryptInput`](crate::deps::aws_cryptography_materialProviders::types::ValidateCommitmentPolicyOnDecryptInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
