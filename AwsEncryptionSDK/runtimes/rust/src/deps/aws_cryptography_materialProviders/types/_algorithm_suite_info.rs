...
impl AlgorithmSuiteInfo {
    /// Creates a new builder-style object to manufacture [`AlgorithmSuiteInfo`](crate::deps::aws_cryptography_materialProviders::types::AlgorithmSuiteInfo).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::types::builders::AlgorithmSuiteInfoBuilder {
        crate::deps::aws_cryptography_materialProviders::types::builders::AlgorithmSuiteInfoBuilder::default()
    }
}

/// A builder for [`AlgorithmSuiteInfo`](crate::deps::aws_cryptography_materialProviders::types::AlgorithmSuiteInfo).
#[non_exhaustive]
#[derive(
...
pub fn get_symmetric_signature(&self) -> &::std::option::Option<crate::deps::aws_cryptography_materialProviders::types::SymmetricSignatureAlgorithm> {
    ...
    /// Consumes the builder and constructs a [`AlgorithmSuiteInfo`](crate::deps::aws_cryptography_materialProviders::types::AlgorithmSuiteInfo).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_materialProviders::types::AlgorithmSuiteInfo {
