...
impl GetCacheEntryInput {
    ...
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::operation::get_cache_entry::builders::GetCacheEntryInputBuilder {
        crate::deps::aws_cryptography_materialProviders::operation::get_cache_entry::builders::GetCacheEntryInputBuilder::default()
    }
}
...
pub fn get_identifier(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_materialProviders::operation::get_cache_entry::GetCacheEntryInput {
