...
impl CreateAwsKmsMultiKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsMultiKeyringInput`](crate::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringInput).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringInputBuilder {
        crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_multi_keyring::builders::CreateAwsKmsMultiKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsMultiKeyringInput`](crate::operation::operation::CreateAwsKmsMultiKeyringInput).
#[non_exhaustive]
#[derive(
    ::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug,
)]
pub struct CreateAwsKmsMultiKeyringInputBuilder {
...
pub fn get_kms_key_ids(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsMultiKeyringInput`](crate::operation::operation::CreateAwsKmsMultiKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_multi_keyring::CreateAwsKmsMultiKeyringInput {
