...
impl CreateKeyringOutput {
    /// Creates a new builder-style object to manufacture [`CreateKeyringOutput`](crate::operation::create_aws_kms_ecdh_keyring::builders::CreateKeyringOutput).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_ecdh_keyring::builders::CreateKeyringOutputBuilder {
        crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_ecdh_keyring::builders::CreateKeyringOutputBuilder::default()
    }
}
...
pub fn get_keyring(&self) -> &::std::option::Option<crate::deps::aws_cryptography_materialProviders::types::keyring::KeyringRef> {
    ...
    pub fn build(
        ...
        crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_ecdh_keyring::CreateKeyringOutput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_ecdh_keyring::CreateKeyringOutput {
