...
impl CreateAwsKmsEcdhKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsEcdhKeyringInput`](crate::operation::create_aws_kms_ecdh_keyring::builders::CreateAwsKmsEcdhKeyringInput).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_ecdh_keyring::builders::CreateAwsKmsEcdhKeyringInputBuilder {
        crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_ecdh_keyring::builders::CreateAwsKmsEcdhKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsEcdhKeyringInput`](crate::operation::operation::CreateAwsKmsEcdhKeyringInput).
#[non_exhaustive]
#[derive(
...
pub fn get_kms_client(&self) -> &::std::option::Option<crate::deps::com_amazonaws_kms::client::Client> {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsEcdhKeyringInput`](crate::operation::operation::CreateAwsKmsEcdhKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_ecdh_keyring::CreateAwsKmsEcdhKeyringInput {
