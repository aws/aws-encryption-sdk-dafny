...
impl CreateAwsKmsMrkDiscoveryMultiKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateAwsKmsMrkDiscoveryMultiKeyringInput`](crate::operation::create_aws_kms_mrk_discovery_multi_keyring::builders::CreateAwsKmsMrkDiscoveryMultiKeyringInput).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_mrk_discovery_multi_keyring::builders::CreateAwsKmsMrkDiscoveryMultiKeyringInputBuilder {
        crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_mrk_discovery_multi_keyring::builders::CreateAwsKmsMrkDiscoveryMultiKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateAwsKmsMrkDiscoveryMultiKeyringInput`](crate::operation::operation::CreateAwsKmsMrkDiscoveryMultiKeyringInput).
#[non_exhaustive]
#[derive(
...
pub fn get_regions(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`CreateAwsKmsMrkDiscoveryMultiKeyringInput`](crate::operation::operation::CreateAwsKmsMrkDiscoveryMultiKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
