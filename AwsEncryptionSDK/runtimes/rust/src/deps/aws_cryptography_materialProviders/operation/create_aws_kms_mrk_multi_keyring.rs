...
/// Orchestration and serialization glue logic for `CreateAwsKmsMrkMultiKeyring`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateAwsKmsMrkMultiKeyring;
impl CreateAwsKmsMrkMultiKeyring {
...
pub use crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_mrk_multi_keyring::_create_keyring_output::CreateKeyringOutput;

pub use crate::deps::aws_cryptography_materialProviders::operation::create_aws_kms_mrk_multi_keyring::_create_aws_kms_mrk_multi_keyring_input::CreateAwsKmsMrkMultiKeyringInput;

pub(crate) mod _create_keyring_output;

pub(crate) mod _create_aws_kms_mrk_multi_keyring_input;
