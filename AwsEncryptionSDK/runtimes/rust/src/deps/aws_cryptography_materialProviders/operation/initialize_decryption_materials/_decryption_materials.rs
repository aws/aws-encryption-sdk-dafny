...
impl DecryptionMaterials {
    /// Creates a new builder-style object to manufacture [`DecryptionMaterials`](crate::operation::initialize_decryption_materials::builders::DecryptionMaterials).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::operation::initialize_decryption_materials::builders::DecryptionMaterialsBuilder {
        crate::deps::aws_cryptography_materialProviders::operation::initialize_decryption_materials::builders::DecryptionMaterialsBuilder::default()
    }
}
...
pub fn get_verification_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_materialProviders::operation::initialize_decryption_materials::DecryptionMaterials {
