...
impl InitializeDecryptionMaterialsInput {
    /// Creates a new builder-style object to manufacture [`InitializeDecryptionMaterialsInput`](crate::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsInput).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsInputBuilder {
        crate::deps::aws_cryptography_materialProviders::operation::initialize_decryption_materials::builders::InitializeDecryptionMaterialsInputBuilder::default()
    }
}

/// A builder for [`InitializeDecryptionMaterialsInput`](crate::operation::operation::InitializeDecryptionMaterialsInput).
#[non_exhaustive]
#[derive(
...
pub fn get_required_encryption_context_keys(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`InitializeDecryptionMaterialsInput`](crate::operation::operation::InitializeDecryptionMaterialsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
