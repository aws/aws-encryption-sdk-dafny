...
impl GetEncryptionMaterialsInput {
    /// Creates a new builder-style object to manufacture [`GetEncryptionMaterialsInput`](crate::operation::get_encryption_materials::builders::GetEncryptionMaterialsInput).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::operation::get_encryption_materials::builders::GetEncryptionMaterialsInputBuilder {
        crate::deps::aws_cryptography_materialProviders::operation::get_encryption_materials::builders::GetEncryptionMaterialsInputBuilder::default()
    }
}

/// A builder for [`GetEncryptionMaterialsInput`](crate::operation::operation::GetEncryptionMaterialsInput).
#[non_exhaustive]
#[derive(
...
pub fn get_required_encryption_context_keys(&self) -> &::std::option::Option<::std::vec::Vec<::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`GetEncryptionMaterialsInput`](crate::operation::operation::GetEncryptionMaterialsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_materialProviders::operation::get_encryption_materials::GetEncryptionMaterialsInput {
