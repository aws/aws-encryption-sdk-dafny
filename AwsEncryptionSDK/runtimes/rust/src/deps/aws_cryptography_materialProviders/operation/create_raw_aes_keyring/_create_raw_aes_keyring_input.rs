...
impl CreateRawAesKeyringInput {
    /// Creates a new builder-style object to manufacture [`CreateRawAesKeyringInput`](crate::operation::create_raw_aes_keyring::builders::CreateRawAesKeyringInput).
    pub fn builder() -> crate::deps::aws_cryptography_materialProviders::operation::create_raw_aes_keyring::builders::CreateRawAesKeyringInputBuilder {
        crate::deps::aws_cryptography_materialProviders::operation::create_raw_aes_keyring::builders::CreateRawAesKeyringInputBuilder::default()
    }
}

/// A builder for [`CreateRawAesKeyringInput`](crate::operation::operation::CreateRawAesKeyringInput).
#[non_exhaustive]
#[derive(
...
pub fn get_wrapping_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`CreateRawAesKeyringInput`](crate::operation::operation::CreateRawAesKeyringInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
