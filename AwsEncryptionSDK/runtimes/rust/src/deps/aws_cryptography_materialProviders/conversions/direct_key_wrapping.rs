...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::deps::aws_cryptography_materialProviders::types::DirectKeyWrapping>,
...
pub fn plain_from_dafny(
    dafny_value: &crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::DIRECT_KEY_WRAPPING,
) -> crate::deps::aws_cryptography_materialProviders::types::DirectKeyWrapping {
    match dafny_value {
        crate::r#software::amazon::cryptography::materialproviders::internaldafny::types::DIRECT_KEY_WRAPPING::DIRECT_KEY_WRAPPING {..} =>
            crate::deps::aws_cryptography_materialProviders::types::DirectKeyWrapping::builder()
