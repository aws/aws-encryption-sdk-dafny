...
#[allow(dead_code)]
pub fn to_dafny(
    value: crate::deps::aws_cryptography_keyStore::operation::create_key::CreateKeyInput,
) -> ::std::rc::Rc<
...
pub fn from_dafny(
    ...
    crate::deps::aws_cryptography_keyStore::operation::create_key::CreateKeyInput::builder()
