...
pub fn to_dafny(
    value: crate::deps::aws_cryptography_keyStore::types::error::Error,
) -> ::std::rc::Rc<crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error> {
    ::std::rc::Rc::new(match value {
        crate::deps::aws_cryptography_keyStore::types::error::Error::KeyStoreException { message } =>
...
crate::deps::aws_cryptography_keyStore::types::error::Error::DynamoDB_20120810Error { error } =>
    crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::ComAmazonawsDynamodb {
        ComAmazonawsDynamodb: crate::deps::com_amazonaws_dynamodb::conversions::error::to_dafny(error),
    },
crate::deps::aws_cryptography_keyStore::types::error::Error::TrentServiceError { error } =>
    crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::ComAmazonawsKms {
        ComAmazonawsKms: crate::deps::com_amazonaws_kms::conversions::error::to_dafny(error),
    },
        crate::deps::aws_cryptography_keyStore::types::error::Error::CollectionOfErrors { list, message } =>
        ...
        crate::deps::aws_cryptography_keyStore::types::error::Error::ValidationError(inner) => {
        ...
        crate::deps::aws_cryptography_keyStore::types::error::Error::Opaque { obj, alt_text } =>
            crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::Opaque {
...
pub fn from_dafny(
    ...
    crate::deps::aws_cryptography_keyStore::types::error::Error::KeyStoreException {
        message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(&message),
    },
crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::ComAmazonawsDynamodb { ComAmazonawsDynamodb } =>
    crate::deps::aws_cryptography_keyStore::types::error::Error::DynamoDB_20120810Error {
        error: crate::deps::com_amazonaws_dynamodb::conversions::error::from_dafny(ComAmazonawsDynamodb.clone()),
    },
crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::ComAmazonawsKms { ComAmazonawsKms } =>
    crate::deps::aws_cryptography_keyStore::types::error::Error::TrentServiceError {
        ...
        crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::CollectionOfErrors { list, message } =>
            crate::deps::aws_cryptography_keyStore::types::error::Error::CollectionOfErrors {
                message: ::dafny_runtime::dafny_runtime_conversions::unicode_chars_false::dafny_string_to_string(&message),
                list: ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(&list, |e| from_dafny(e.clone()))
            },
        crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::Opaque { obj, alt_text } =>
        ...
        crate::r#software::amazon::cryptography::keystore::internaldafny::types::Error::Opaque { obj, alt_text } =>
            {
                use ::std::any::Any;
                if ::dafny_runtime::is_object!(obj, crate::deps::aws_cryptography_keyStore::types::error::ValidationError) {
                    let typed = ::dafny_runtime::cast_object!(obj.clone(), crate::deps::aws_cryptography_keyStore::types::error::ValidationError);
                    crate::deps::aws_cryptography_keyStore::types::error::Error::ValidationError(
