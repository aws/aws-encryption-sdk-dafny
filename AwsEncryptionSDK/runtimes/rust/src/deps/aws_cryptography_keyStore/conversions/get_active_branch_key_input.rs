...
pub fn option_to_dafny(
  value: ::std::option::Option<crate::deps::aws_cryptography_keyStore::types::GetActiveBranchKeyInput>,
...
pub fn plain_from_dafny(
    dafny_value: &crate::r#software::amazon::cryptography::keystore::internaldafny::types::GetActiveBranchKeyInput,
) -> crate::deps::aws_cryptography_keyStore::types::GetActiveBranchKeyInput {
    match dafny_value {
        crate::r#software::amazon::cryptography::keystore::internaldafny::types::GetActiveBranchKeyInput::GetActiveBranchKeyInput {..} =>
            crate::deps::aws_cryptography_keyStore::types::GetActiveBranchKeyInput::builder()
...
pub fn option_from_dafny(
    dafny_value: ::std::rc::Rc<crate::_Wrappers_Compile::Option<::std::rc::Rc<
        crate::r#software::amazon::cryptography::keystore::internaldafny::types::GetActiveBranchKeyInput,
    >>>,
) -> ::std::option::Option<crate::deps::aws_cryptography_keyStore::types::GetActiveBranchKeyInput> {
    match &*dafny_value {
