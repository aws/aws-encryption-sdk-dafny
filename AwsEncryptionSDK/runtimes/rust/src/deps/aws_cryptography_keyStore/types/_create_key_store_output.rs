...
impl CreateKeyStoreOutput {
    /// Creates a new builder-style object to manufacture [`CreateKeyStoreOutput`](crate::deps::aws_cryptography_keyStore::types::CreateKeyStoreOutput).
    pub fn builder() -> crate::deps::aws_cryptography_keyStore::types::builders::CreateKeyStoreOutputBuilder {
        crate::deps::aws_cryptography_keyStore::types::builders::CreateKeyStoreOutputBuilder::default()
    }
}
...
pub fn get_table_arn(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`CreateKeyStoreOutput`](crate::deps::aws_cryptography_keyStore::types::CreateKeyStoreOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
