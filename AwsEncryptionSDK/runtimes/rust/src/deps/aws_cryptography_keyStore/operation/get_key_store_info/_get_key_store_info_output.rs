...
impl GetKeyStoreInfoOutput {
    /// Creates a new builder-style object to manufacture [`GetKeyStoreInfoOutput`](crate::operation::get_key_store_info::builders::GetKeyStoreInfoOutput).
    pub fn builder() -> crate::deps::aws_cryptography_keyStore::operation::get_key_store_info::builders::GetKeyStoreInfoOutputBuilder {
        crate::deps::aws_cryptography_keyStore::operation::get_key_store_info::builders::GetKeyStoreInfoOutputBuilder::default()
    }
}

/// A builder for [`GetKeyStoreInfoOutput`](crate::operation::operation::GetKeyStoreInfoOutput).
#[non_exhaustive]
#[derive(
...
pub fn get_logical_key_store_name(&self) -> &::std::option::Option<::std::string::String> {
    ...
    /// Consumes the builder and constructs a [`GetKeyStoreInfoOutput`](crate::operation::operation::GetKeyStoreInfoOutput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_keyStore::operation::get_key_store_info::GetKeyStoreInfoOutput {
