...
impl CreateKeyInput {
    /// Creates a new builder-style object to manufacture [`CreateKeyInput`](crate::operation::create_key::builders::CreateKeyInput).
    pub fn builder() -> crate::deps::aws_cryptography_keyStore::operation::create_key::builders::CreateKeyInputBuilder {
        crate::deps::aws_cryptography_keyStore::operation::create_key::builders::CreateKeyInputBuilder::default()
    }
}

/// A builder for [`CreateKeyInput`](crate::operation::operation::CreateKeyInput).
#[non_exhaustive]
#[derive(
...
pub fn get_encryption_context(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>> {
    ...
    /// Consumes the builder and constructs a [`CreateKeyInput`](crate::operation::operation::CreateKeyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::deps::aws_cryptography_keyStore::operation::create_key::CreateKeyInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_keyStore::operation::create_key::CreateKeyInput {
