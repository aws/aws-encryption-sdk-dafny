...
impl GetBeaconKeyOutput {
    ...
    pub fn builder() -> crate::deps::aws_cryptography_keyStore::operation::get_beacon_key::builders::GetBeaconKeyOutputBuilder {
        crate::deps::aws_cryptography_keyStore::operation::get_beacon_key::builders::GetBeaconKeyOutputBuilder::default()
    }
}
...
pub fn get_beacon_key_materials(&self) -> &::std::option::Option<crate::deps::aws_cryptography_keyStore::types::BeaconKeyMaterials> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_keyStore::operation::get_beacon_key::GetBeaconKeyOutput {
