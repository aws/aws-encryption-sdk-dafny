    ...
    crate::r#_Wrappers_Compile::Option::Some { value } =>
        Some(
            ::dafny_runtime::dafny_runtime_conversions::dafny_sequence_to_vec(value,
                |e: &::std::rc::Rc<crate::r#software::amazon::cryptography::services::kms::internaldafny::types::CustomKeyStoresListEntry>| crate::deps::com_amazonaws_kms::conversions::custom_key_stores_list_entry::from_dafny(e.clone())
,
            )
        ),
    _ => None
