...
{
  let x: std::rc::Rc<crate::deps::com_amazonaws_kms::client::Client> = std::rc::Rc::new(value.clone());
  let y = x as std::rc::Rc<dyn crate::r#software::amazon::cryptography::services::kms::internaldafny::types::IKMSClient>;
  unsafe {
...
pub fn from_dafny(
  ...
  if (dafny_runtime::is_object!(as_boxed_any, crate::deps::com_amazonaws_kms::client::Client)) {
    let as_boxed_client = ::dafny_runtime::object::downcast::<crate::deps::com_amazonaws_kms::client::Client>(as_boxed_any);
    unsafe {
