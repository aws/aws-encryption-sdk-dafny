...
pub fn to_dafny_error(
    ...
    match value {
      aws_sdk_kms::error::SdkError::ServiceError(service_error) => match service_error.err() {
         ...
         aws_sdk_kms::operation::disable_key_rotation::DisableKeyRotationError::DisabledException(e) =>
            crate::deps::com_amazonaws_kms::conversions::error::disabled_exception::to_dafny(e.clone()),
         aws_sdk_kms::operation::disable_key_rotation::DisableKeyRotationError::InvalidArnException(e) =>
            crate::deps::com_amazonaws_kms::conversions::error::invalid_arn_exception::to_dafny(e.clone()),
         aws_sdk_kms::operation::disable_key_rotation::DisableKeyRotationError::KmsInternalException(e) =>
            crate::deps::com_amazonaws_kms::conversions::error::kms_internal_exception::to_dafny(e.clone()),
         aws_sdk_kms::operation::disable_key_rotation::DisableKeyRotationError::KmsInvalidStateException(e) =>
            crate::deps::com_amazonaws_kms::conversions::error::kms_invalid_state_exception::to_dafny(e.clone()),
         aws_sdk_kms::operation::disable_key_rotation::DisableKeyRotationError::NotFoundException(e) =>
