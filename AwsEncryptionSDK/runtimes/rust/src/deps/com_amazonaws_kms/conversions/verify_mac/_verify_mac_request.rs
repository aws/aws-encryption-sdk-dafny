...
>{
 ...
 Mac: crate::standard_library_conversions::oblob_to_dafny(&value.mac).Extract(),
...
pub fn from_dafny(
 ...
 .set_mac(Some(crate::standard_library_conversions::blob_from_dafny(dafny_value.Mac().clone())))
