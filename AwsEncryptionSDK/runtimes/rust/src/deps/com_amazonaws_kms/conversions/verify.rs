...
pub fn to_dafny_error(
    ...
    match value {
      aws_sdk_kms::error::SdkError::ServiceError(service_error) => match service_error.err() {
         ...
         aws_sdk_kms::operation::verify::VerifyError::DryRunOperationException(e) =>
         ...
         aws_sdk_kms::operation::verify::VerifyError::KmsInvalidSignatureException(e) =>
            crate::deps::com_amazonaws_kms::conversions::error::kms_invalid_signature_exception::to_dafny(e.clone()),
