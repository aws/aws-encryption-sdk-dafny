...
impl DigestInput {
    /// Creates a new builder-style object to manufacture [`DigestInput`](crate::deps::aws_cryptography_primitives::types::DigestInput).
    pub fn builder() -> crate::deps::aws_cryptography_primitives::types::builders::DigestInputBuilder {
        crate::deps::aws_cryptography_primitives::types::builders::DigestInputBuilder::default()
    }
}

/// A builder for [`DigestInput`](crate::deps::aws_cryptography_primitives::types::DigestInput).
#[non_exhaustive]
#[derive(
...
pub fn get_message(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`DigestInput`](crate::deps::aws_cryptography_primitives::types::DigestInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_primitives::types::DigestInput {
