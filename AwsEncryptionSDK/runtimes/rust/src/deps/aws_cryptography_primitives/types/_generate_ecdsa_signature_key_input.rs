...
impl GenerateEcdsaSignatureKeyInput {
    /// Creates a new builder-style object to manufacture [`GenerateEcdsaSignatureKeyInput`](crate::deps::aws_cryptography_primitives::types::GenerateEcdsaSignatureKeyInput).
    pub fn builder() -> crate::deps::aws_cryptography_primitives::types::builders::GenerateEcdsaSignatureKeyInputBuilder {
        crate::deps::aws_cryptography_primitives::types::builders::GenerateEcdsaSignatureKeyInputBuilder::default()
    }
}

/// A builder for [`GenerateEcdsaSignatureKeyInput`](crate::deps::aws_cryptography_primitives::types::GenerateEcdsaSignatureKeyInput).
#[non_exhaustive]
#[derive(
...
pub fn get_signature_algorithm(&self) -> &::std::option::Option<crate::deps::aws_cryptography_primitives::types::EcdsaSignatureAlgorithm> {
    ...
    /// Consumes the builder and constructs a [`GenerateEcdsaSignatureKeyInput`](crate::deps::aws_cryptography_primitives::types::GenerateEcdsaSignatureKeyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_primitives::types::GenerateEcdsaSignatureKeyInput {
