...
impl AesDecryptInput {
    /// Creates a new builder-style object to manufacture [`AesDecryptInput`](crate::deps::aws_cryptography_primitives::types::AesDecryptInput).
    pub fn builder() -> crate::deps::aws_cryptography_primitives::types::builders::AesDecryptInputBuilder {
        crate::deps::aws_cryptography_primitives::types::builders::AesDecryptInputBuilder::default()
    }
}

/// A builder for [`AesDecryptInput`](crate::deps::aws_cryptography_primitives::types::AesDecryptInput).
#[non_exhaustive]
#[derive(
...
pub fn get_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`AesDecryptInput`](crate::deps::aws_cryptography_primitives::types::AesDecryptInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_primitives::types::AesDecryptInput {
            aad: self.aad,
