...
impl DeriveSharedSecretInput {
    ...
    pub fn builder() -> crate::deps::aws_cryptography_primitives::types::builders::DeriveSharedSecretInputBuilder {
...
pub fn get_public_key(&self) -> &::std::option::Option<crate::deps::aws_cryptography_primitives::types::EccPublicKey> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_primitives::types::DeriveSharedSecretInput {
