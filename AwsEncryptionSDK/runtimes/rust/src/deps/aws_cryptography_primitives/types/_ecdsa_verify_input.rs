...
impl EcdsaVerifyInput {
    /// Creates a new builder-style object to manufacture [`EcdsaVerifyInput`](crate::deps::aws_cryptography_primitives::types::EcdsaVerifyInput).
    pub fn builder() -> crate::deps::aws_cryptography_primitives::types::builders::EcdsaVerifyInputBuilder {
        crate::deps::aws_cryptography_primitives::types::builders::EcdsaVerifyInputBuilder::default()
    }
}

/// A builder for [`EcdsaVerifyInput`](crate::deps::aws_cryptography_primitives::types::EcdsaVerifyInput).
#[non_exhaustive]
#[derive(
...
pub fn get_verification_key(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`EcdsaVerifyInput`](crate::deps::aws_cryptography_primitives::types::EcdsaVerifyInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_primitives::types::EcdsaVerifyInput {
