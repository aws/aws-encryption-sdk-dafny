...
impl DeriveSharedSecretInput {
    /// Creates a new builder-style object to manufacture [`DeriveSharedSecretInput`](crate::operation::derive_shared_secret::builders::DeriveSharedSecretInput).
    pub fn builder() -> crate::deps::aws_cryptography_primitives::operation::derive_shared_secret::builders::DeriveSharedSecretInputBuilder {
        crate::deps::aws_cryptography_primitives::operation::derive_shared_secret::builders::DeriveSharedSecretInputBuilder::default()
    }
}

/// A builder for [`DeriveSharedSecretInput`](crate::operation::operation::DeriveSharedSecretInput).
#[non_exhaustive]
#[derive(
...
pub fn get_public_key(&self) -> &::std::option::Option<crate::deps::aws_cryptography_primitives::types::EccPublicKey> {
    ...
    /// Consumes the builder and constructs a [`DeriveSharedSecretInput`](crate::operation::operation::DeriveSharedSecretInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_primitives::operation::derive_shared_secret::DeriveSharedSecretInput {
