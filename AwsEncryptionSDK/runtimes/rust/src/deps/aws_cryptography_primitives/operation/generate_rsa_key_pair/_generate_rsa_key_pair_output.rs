...
impl GenerateRsaKeyPairOutput {
    ...
    pub fn builder() -> crate::deps::aws_cryptography_primitives::operation::generate_rsa_key_pair::builders::GenerateRsaKeyPairOutputBuilder {
        crate::deps::aws_cryptography_primitives::operation::generate_rsa_key_pair::builders::GenerateRsaKeyPairOutputBuilder::default()
    }
}
...
pub fn get_public_key(&self) -> &::std::option::Option<crate::deps::aws_cryptography_primitives::types::RsaPublicKey> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_primitives::operation::generate_rsa_key_pair::GenerateRsaKeyPairOutput {
