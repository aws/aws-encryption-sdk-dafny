...
impl KdfCtrInput {
    /// Creates a new builder-style object to manufacture [`KdfCtrInput`](crate::operation::kdf_counter_mode::builders::KdfCtrInput).
    pub fn builder() -> crate::deps::aws_cryptography_primitives::operation::kdf_counter_mode::builders::KdfCtrInputBuilder {
        crate::deps::aws_cryptography_primitives::operation::kdf_counter_mode::builders::KdfCtrInputBuilder::default()
    }
}

/// A builder for [`KdfCtrInput`](crate::operation::operation::KdfCtrInput).
#[non_exhaustive]
#[derive(
...
pub fn get_purpose(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`KdfCtrInput`](crate::operation::operation::KdfCtrInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_primitives::operation::kdf_counter_mode::KdfCtrInput {
