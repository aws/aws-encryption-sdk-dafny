...
/// A builder for [`AesKdfCtrInput`](crate::operation::operation::AesKdfCtrInput).
#[non_exhaustive]
#[derive(
...
pub fn get_nonce(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_primitives::operation::aes_kdf_counter_mode::AesKdfCtrInput {
