...
impl HMacInput {
    ...
    pub fn builder() -> crate::deps::aws_cryptography_primitives::operation::h_mac::builders::HMacInputBuilder {
...
pub fn get_message(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_primitives::operation::h_mac::HMacInput {
