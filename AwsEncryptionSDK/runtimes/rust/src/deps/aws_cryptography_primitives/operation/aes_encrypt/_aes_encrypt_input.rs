...
impl AesEncryptInput {
    /// Creates a new builder-style object to manufacture [`AesEncryptInput`](crate::operation::aes_encrypt::builders::AesEncryptInput).
    pub fn builder() -> crate::deps::aws_cryptography_primitives::operation::aes_encrypt::builders::AesEncryptInputBuilder {
        crate::deps::aws_cryptography_primitives::operation::aes_encrypt::builders::AesEncryptInputBuilder::default()
    }
}

/// A builder for [`AesEncryptInput`](crate::operation::operation::AesEncryptInput).
#[non_exhaustive]
#[derive(
...
pub fn get_msg(&self) -> &::std::option::Option<::aws_smithy_types::Blob> {
    ...
    /// Consumes the builder and constructs a [`AesEncryptInput`](crate::operation::operation::AesEncryptInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
    ...
    > {
        ::std::result::Result::Ok(crate::deps::aws_cryptography_primitives::operation::aes_encrypt::AesEncryptInput {
            aad: self.aad,
