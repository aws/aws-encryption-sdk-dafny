...
pub use crate::deps::aws_cryptography_primitives::operation::validate_public_key::_validate_public_key_output::ValidatePublicKeyOutputBuilder;

pub use crate::deps::aws_cryptography_primitives::operation::validate_public_key::_validate_public_key_input::ValidatePublicKeyInputBuilder;
...
pub struct ValidatePublicKeyFluentBuilder {
    client: crate::deps::aws_cryptography_primitives::client::Client,
    pub(crate) inner: crate::deps::aws_cryptography_primitives::operation::validate_public_key::builders::ValidatePublicKeyInputBuilder,
}
impl ValidatePublicKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::deps::aws_cryptography_primitives::operation::validate_public_key::builders::ValidatePublicKeyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::deps::aws_cryptography_primitives::operation::validate_public_key::ValidatePublicKey::send(&self.client, input).await
    }
