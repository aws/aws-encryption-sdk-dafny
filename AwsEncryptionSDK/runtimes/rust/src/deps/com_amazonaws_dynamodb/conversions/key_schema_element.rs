...
) -> ::std::rc::Rc<crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::KeySchemaElement>{
  ::std::rc::Rc::new(
...
pub fn from_dafny(
 ...
 .set_key_type(Some( crate::deps::com_amazonaws_dynamodb::conversions::key_type::from_dafny(dafny_value.KeyType()) ))
          .build()
          .unwrap()
}
