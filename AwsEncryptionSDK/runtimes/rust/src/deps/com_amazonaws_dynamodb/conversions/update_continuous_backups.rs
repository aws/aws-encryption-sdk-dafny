...
pub fn to_dafny_error(
    ...
    match value {
      aws_sdk_dynamodb::error::SdkError::ServiceError(service_error) => match service_error.err() {
                aws_sdk_dynamodb::operation::update_continuous_backups::UpdateContinuousBackupsError::ContinuousBackupsUnavailableException(e) =>
            crate::deps::com_amazonaws_dynamodb::conversions::error::continuous_backups_unavailable_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::update_continuous_backups::UpdateContinuousBackupsError::InternalServerError(e) =>
            crate::deps::com_amazonaws_dynamodb::conversions::error::internal_server_error::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::update_continuous_backups::UpdateContinuousBackupsError::InvalidEndpointException(e) =>
            crate::deps::com_amazonaws_dynamodb::conversions::error::invalid_endpoint_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::update_continuous_backups::UpdateContinuousBackupsError::TableNotFoundException(e) =>
 ...
 pub mod _update_continuous_backups_request;

 pub mod _update_continuous_backups_response;
