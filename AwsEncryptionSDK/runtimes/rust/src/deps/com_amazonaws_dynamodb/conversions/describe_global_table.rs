...
pub fn to_dafny_error(
    ...
    match value {
      aws_sdk_dynamodb::error::SdkError::ServiceError(service_error) => match service_error.err() {
                aws_sdk_dynamodb::operation::describe_global_table::DescribeGlobalTableError::GlobalTableNotFoundException(e) =>
            crate::deps::com_amazonaws_dynamodb::conversions::error::global_table_not_found_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::describe_global_table::DescribeGlobalTableError::InternalServerError(e) =>
            crate::deps::com_amazonaws_dynamodb::conversions::error::internal_server_error::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::describe_global_table::DescribeGlobalTableError::InvalidEndpointException(e) =>
 ...
 pub mod _describe_global_table_request;
