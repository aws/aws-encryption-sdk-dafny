...
pub fn to_dafny_error(
    value: &::aws_smithy_runtime_api::client::result::SdkError<
        aws_sdk_dynamodb::operation::import_table::ImportTableError,
        ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
    >,
) -> ::std::rc::Rc<crate::r#software::amazon::cryptography::services::dynamodb::internaldafny::types::Error> {
    match value {
      aws_sdk_dynamodb::error::SdkError::ServiceError(service_error) => match service_error.err() {
                aws_sdk_dynamodb::operation::import_table::ImportTableError::ImportConflictException(e) =>
            crate::deps::com_amazonaws_dynamodb::conversions::error::import_conflict_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::import_table::ImportTableError::LimitExceededException(e) =>
            crate::deps::com_amazonaws_dynamodb::conversions::error::limit_exceeded_exception::to_dafny(e.clone()),
         aws_sdk_dynamodb::operation::import_table::ImportTableError::ResourceInUseException(e) =>
