...
namespace AWSEncryptionSDK
{
    ...
    //         Result<ibyteseq, icharseq> result = ESDKClient.__default.Encrypt(request.GetDafnyRequest());
    ...
    //         // TODO: Might need a lock here if ANYTHING in the Dafny runtime isn't threadsafe!
    //         Result<ibyteseq, icharseq> result = ESDKClient.__default.Decrypt(request.GetDafnyRequest());
    //
    //         return DafnyFFI.MemoryStreamFromSequence(DafnyFFI.ExtractResult(result));
    //     }
    //
    ...
    //             var optionalAlgID = this.algorithmSuiteID != null ? Option<ushort>.create_Some((ushort)this.algorithmSuiteID) : Option<ushort>.create_None();
    //
    ...
    //                 frameLength: this.frameLength != null ? Option<uint>.create_Some((uint)this.frameLength) : Option<uint>.create_None()
    //             );
    //         }
    //     }
    //
